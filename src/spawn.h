...
struct ui_bar *spawn_ui_bar(struct std_list **object_list_stack_ptr, struct dict_str_void *generic_anim_dict, struct graphics_struct *graphics, int *bar_amount_ptr, int *bar_max_ptr, struct visual_container_struct *container, const char *name);
struct ui_counter *spawn_ui_counter(struct std_list **object_list_stack_ptr, struct dict_str_void *generic_anim_dict, struct graphics_struct *graphics, int *counter_value_ptr, int digits, struct visual_container_struct *container, const char *name, float *currentbeat_ptr);
