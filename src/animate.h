...
struct animate_specific *render_node_populate2(struct render_node **render_node_head_ptr, SDL_Texture **imgList, SDL_Renderer *renderer, struct dict_str_void *generic_anim_dict);

//struct animate_specific *generate_specific_anim(struct std *std, struct dict_str_void *generic_anim_dict, int index);
...
//int graphic_spawn(struct std *std, struct dict_str_void *generic_anim_dict, struct graphics_struct *graphics, enum graphic_type_e *index_array, int num_index);
